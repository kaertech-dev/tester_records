...
db_host = os.getenv("DB_HOST", "192.168.2.5")# change the .1.38 to 2.5
...
proj_host = os.getenv("PROJECTS_DB_HOST", "192.168.2.5")# change the .1.38 to 2.5
...
process_db_host = os.getenv("PROCESS_DB_HOST", "192.168.2.5")# change the .1.38 to 2.5
